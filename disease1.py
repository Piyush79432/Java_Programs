disease_dic= {
    'Apple___Apple_scab': {
        'Crop': 'Apple',
        'Disease': 'Apple Scab',
        'Cause': """Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.
        ...
        'Remedy': ['1. Choose resistant varieties when possible.',
    ...
    'Apple___Black_rot': {
        ...
        'Remedy': ['1. Prune out dead or diseased branches.',
                     '2. Remove infected plant material from the area.',
                     '3. Be sure to remove the stumps of any apple trees you cut down. Dead stumps can be a source of spores.']
    },
    ...
    'Apple___Cedar_apple_rust': {
        ...
        'Remedy': ['1. Since the juniper galls are the source of the spores that infect the apple trees, cutting them is a sound strategy if there aren’t too many of them.',
    ...
    'Cherry_(including_sour)___Powdery_mildew': {
        ...
        'Remedy': ['1. Remove and destroy sucker shoots.',
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': {
        ...
        'Remedy': ['1. In order to best prevent and manage corn grey leaf spot, the overall approach is to reduce the rate of disease growth and expansion.',
    ...
    'Corn_(maize)___Common_rust_': {
        ...
        'Remedy': ['1. Although rust is frequently found on corn in Ohio, very rarely has there been a need for fungicide applications. This is due to the fact that there are highly resistant field corn hybrids available and most possess some degree of resistance.',
    ...
    'Corn_(maize)___Northern_Leaf_Blight': {
        ...
        'Remedy': ["1. Management of NCLB can be achieved primarily by using hybrids with resistance, but because resistance may not be complete or may fail, it is advantageous to utilize an integrated approach with different cropping practices and fungicides.",
    ...
    'Grape___Black_rot': {
        ...
        'Remedy': ['1. Space vines properly and choose a planting site where the vines will be exposed to full sun and good air circulation. Keep the vines off the ground and insure they are properly tied, limiting the amount of time the vines remain wet thus reducing infection.',
    ...
    'Grape___Esca_(Black_Measles)': {
        ...
        'Remedy': ['1. Post-infection practices (sanitation and vine surgery) for use in diseased, mature vineyards are not as effective and are far more costly than adopting preventative practices (delayed pruning, double pruning, and applications of pruning-wound protectants) in young vineyards.',
...
'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': {
    'Crop': 'Grape',
    'Disease': 'Leaf Spot',
    'Cause': """Leaf spot in grapes, caused by Isariopsis, is a fungal disease that typically occurs during periods of warm, humid weather. The fungus overwinters in infected plant debris and can be spread through splashing water or wind. Infection often begins on the lower leaves and spreads upward, creating circular lesions with dark margins and gray centers.""",
    'Remedy': ['1. Prune grapevines regularly to improve air circulation and reduce humidity around the plants.',
                 '2. Remove and destroy infected leaves and plant debris to prevent the spread of the fungus.',
                 '3. Apply fungicides labeled for grape leaf spot disease management, following recommended application rates and schedules.',
                 '4. Avoid overhead irrigation to minimize leaf wetness and reduce the risk of fungal infection.',
                 '5. Monitor grapevines regularly for signs of leaf spot and take prompt action to manage the disease if detected.']
    ...
    'Orange___Haunglongbing_(Citrus_greening)': {
        ...
        'Remedy': ['1. In regions where disease incidence is low, the most common practices are avoiding the spread of infection by removal of symptomatic trees, protecting grove edges through intensive monitoring, use of pesticides, and biological control of the vector ACP.',
    ...
    'Peach___Bacterial_spot': {
        ...
        'Remedy': ['1. The most effective management strategy is the use of pathogen-free certified seeds and disease-free transplants to prevent the introduction of the pathogen into greenhouses and field production areas. Inspect plants very carefully and reject infected transplants- including your own!',
    ...
    'Pepper,_bell___Bacterial_spot': {
        ...
        'Remedy': ['1. The primary management strategy of bacterial spot begins with use of certified pathogen-free seed and disease-free transplants.',
    ...
    'Potato___Early_blight': {
        ...
        'Remedy': ['1. Plant only diseasefree, certified seed.',
    ...
    'Crop': 'Potato',
    'Disease': 'Late Blight',
    'Cause': """Late blight is a potentially devastating disease of potato, infecting leaves, stems and fruits of plants. The disease spreads quickly in fields and can result in total crop failure if untreated. Late blight of potato was responsible for the Irish potato famine of the late 1840s.
    ...
    'Remedy': ['1. Seed infection is unlikely on commercially prepared tomato seed or on saved seed that has been thoroughly dried.',
    ...
    'Squash___Powdery_mildew': {
        'Crop': 'Squash',
        'Disease': 'Powdery mildew',
        'Cause': """Powdery mildew infections favor humid conditions with temperatures around 68-81° F.
        ...
        'Remedy': ['1. Apply fertilizer based on soil test results. Avoid over-applying nitrogen.',
    ...
    'Strawberry___Leaf_scorch': {
        'Crop': 'Strawberry',
        'Disease': 'Leaf Scorch',
        'Cause': """Scorched strawberry leaves are caused by a fungal infection which affects the foliage of strawberry plantings. The fungus responsible is called Diplocarpon earliana.
        ...
        'Remedy': ['1. Since this fungal pathogen over winters on the fallen leaves of infect plants, proper garden sanitation is key.',
    ...
    'Tomato___Bacterial_spot': {
        'Crop': 'Tomato',
        'Disease': 'Bacterial Spot',
        'Cause': """The disease is caused by four species of Xanthomonas (X. euvesicatoria, X. gardneri, X. perforans, and X. vesicatoria). In North Carolina, X. perforans is the predominant species associated with bacterial spot on tomato and X. euvesicatoria is the predominant species associated with the disease on pepper.
                    All four bacteria are strictly aerobic, gram-negative rods with a long whip-like flagellum (tail) that allows them to move in water, which allows them to invade wet plant tissue and cause infection.""",
        'Remedy': ['1. The most effective management strategy is the use of pathogen-free certified seeds and disease-free transplants to prevent the introduction of the pathogen into greenhouses and field production areas. Inspect plants very carefully and reject infected transplants- including your own!',
                    '2. In transplant production greenhouses, minimize overwatering and handling of seedlings when they are wet.',
                    '3. Trays, benches, tools, and greenhouse structures should be washed and sanitized between seedlings crops.',
                    '4. Do not spray, tie, harvest, or handle wet plants as that can spread the disease.']
    ...
    'Tomato___Early_blight': {
        'Crop': 'Tomato',
        'Disease': 'Early Blight',
        'Cause': """Early blight can be caused by two different closely related fungi, Alternaria tomatophila and Alternaria solani.
                    Alternaria tomatophila is more virulent on tomato than A. solani, so in regions where A. tomatophila is found, it is the primary cause of early blight on tomato. However, if A.tomatophila is absent, A.solani will cause early blight on tomato.""",
        'Remedy': ['1. Use pathogen-free seed, or collect seed only from disease-free plants.',
    ...
    'Crop': 'Tomato',
    'Disease': 'Late Blight',
    'Cause': """Late blight is caused by the oomycete Phytophthora infestans. Oomycetes are fungus-like organisms also called water molds, but they are not true fungi.
                There are many different strains of P. infestans. These are called clonal lineages and designated by a number code (i.e. US-23). Many clonal lineages affect both tomato and potato, but some lineages are specific to one host or the other.
                The host range is typically limited to potato and tomato, but hairy nightshade (Solanum physalifolium) is a closely related weed that can readily become infected and may contribute to disease spread. Under ideal conditions, such as a greenhouse, petunia also may become infected.""",
    'Remedy': ['1. Remove and destroy infected plant parts, including leaves, stems, and fruits, to reduce the spread of the disease.',
                ' 2. Apply fungicides labeled for late blight control, following recommended application rates and schedules. Copper-based fungicides are often effective against late blight.',
                 '3. Practice crop rotation to prevent the buildup of inoculum in the soil. Avoid planting tomatoes or potatoes in the same area where late blight has occurred in previous seasons.',
                 '4. Provide good air circulation around tomato plants by spacing them properly and pruning excess foliage.',
                 '5. Avoid overhead irrigation and water tomato plants at the base to reduce leaf wetness and minimize conditions favorable for disease development.',
                 '6. Monitor tomato plants regularly for signs of late blight and take prompt action if symptoms are detected.']
},

    'Tomato___Leaf_Mold': {
        'Crop': 'Tomato',
        'Disease': 'Leaf Mold',
        'Cause': """Leaf mold is caused by the fungus Passalora fulva (previously called Fulvia fulva or Cladosporium fulvum). It is not known to be pathogenic on any plant other than tomato.
        ...
        'Remedy': ['1. Use drip irrigation and avoid watering foliage.',
    ...
    'Tomato___Septoria_leaf_spot': {
        ...
        'Remedy': ['1. Remove diseased leaves.',
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': {
        ...
        'Cause': """The two-spotted spider mite is the most common mite species that attacks vegetable and fruit crops.
                    They have up to 20 generations per year and are favored by excess nitrogen and dry and dusty conditions.
                    Outbreaks are often caused by the use of broad-spectrum insecticides which interfere with the numerous natural enemies that help to manage mite populations.""",
        'Remedy': ['1. Avoid early season, broad-spectrum insecticide applications for other pests.',
    ...
    'Tomato___Target_Spo': {
        'Crop': 'Tomato',
        'Disease': 'Target Spot',
        'Cause': """The fungus causes plants to lose their leaves; it is a major disease. If infection occurs before the fruit has developed, yields are low.
                    This is a common disease on tomato in Pacific island countries. The disease occurs in the screen house and in the field.""",
        'Remedy': [' 1. Remove a few branches from the lower part of the plants to allow better airflow at the base.',
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': {
        ...
        'Cause': """TYLCV is transmitted by the insect vector Bemisia tabaci in a persistent-circulative nonpropagative manner. The virus can be efficiently transmitted during the adult stages.
                    This virus transmission has a short acquisition access period of 15–20 minutes, and latent period of 8–24 hours.""",
        'Remedy': ['1. Currently, the most effective treatments used to control the spread of TYLCV are insecticides and resistant crop varieties.',
    ...
    'Tomato___Tomato_mosaic_virus': {
        ...
        'Cause': """Tomato mosaic virus and tobacco mosaic virus can exist for two years in dry soil or leaf debris, but will only persist one month if soil is moist. The viruses can also survive in infected root debris in the soil for up to two years.
                    ...
                    The virus can even survive the tobacco curing process, and can spread from cigarettes and other tobacco products to plant material handled by workers after a cigarette.""",
        'Remedy': ['1. Purchase transplants only from reputable sources. Ask about the sanitation procedures they use to prevent disease.',
